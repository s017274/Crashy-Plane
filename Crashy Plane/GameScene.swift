...
//  Crashy Plane
//
//  Created by Benjamin Warren (student LM) on 5/23/20.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createRocks() {
        ...
        // 2: Creates the collision rectangle
        ...
        // 3: Sets the gap between the rocks
        ...
        // 4: Positions all the rocks an animates them on the screen
